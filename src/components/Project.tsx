    ...
    >
      ...
      <ol className="relative space-y-8 before:absolute before:-ml-px before:h-full before:w-0.5 before:rounded-full before:bg-gray-200">
        ...
        <li className="relative -ms-1.5 flex items-start gap-4">
          ...
          <div className="-mt-2 flex flex-col gap-3">
            <Link
              href="https://github.com/tongbora/Bakong-API-Integration-with-Spring-Boot"
              target="_blank"
        ...
        <li className="relative -ms-1.5 flex items-start gap-4">
          ...
          <div className="-mt-2 flex flex-col gap-3">
            ...
            >
              ...
              facilitate course management and educational content delivery to
              scholarship and short course programs. exSTAD key features include
              the ability to create and organize training program, centralize
              course materials, manage user roles and enrollments, track learner
        ...
        <li className="relative -ms-1.5 flex items-start gap-4">
          ...
          <div className="-mt-2 flex flex-col gap-3">
            ...
            <p
              className={`${poppins.className} mt-0.5 text-md leading-8 text-gray-700 sm:pr-50 pr-0 sm:text-justify text-start`}
            >
              Fluent-Flow is an innovative English learning platform designed
              specifically for Khmer learners. With bilingual support (English &
              Khmer), interactive lessons, and AI-powered assistance, users can
              improve their English skills through engaging exercises, videos,
              and infographics.
            </p>
          </div>
        </li>
